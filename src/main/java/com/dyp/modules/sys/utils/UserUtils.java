...
import com.dyp.modules.sys.dao.*;
import com.dyp.modules.sys.entity.*;
...
//		UserUtils.clearCache(getUser()); add  later
	}
	...
	/**
	 * 获取当前用户
	 * @return 取不到返回 new User()  add later
	 */
